...
from ipmi.common.timeseries.peak import find_peaks
from ipmi.constants import PI2
...
if __name__ == "__main__":
    ...
    stats = calculate_respiratory_statistics(amplitudes=a, sampling_rate=sampling_rate)
